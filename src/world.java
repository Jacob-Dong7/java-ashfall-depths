...
public class world {
    ...
    public room[] setWorld() {
        room[] dungeon = new room[] {
            ...
            new room("Ash Crossing", "Grey ash coats the floor like snow. \nYour footprints are the only marks disturbing it. \nBurned torches hang dead on the walls. Something here was consumed by fire long ago.", 5, 1, false, false, true, false  ),
            new room("Deep Pit", "The floor suddenly drops away into a wide black pit. \nYou hear faint movement far below. \nLoose stones tumble from the edge and vanish without a sound. One wrong step would be fatal.", 6, 3, false, false , true, true ),
            new room("Sun Gate", "Ahead stands a massive stone doorway split open. \nWarm golden light spills through the cracks, chasing away the cold darkness behind you. Fresh air flows in. This might be the way out.", 7, 0, true, true , true, true ),
        };
        return dungeon;
    }
            ...
            if (userAction == 1) {
                ...
                if (attackChance > 4) {
                    ...
                    if (criticalChance >= 49) {
                        ...
                        System.out.println("------------------------------------------------------------------------------------------");
                        enemyHealth -= newPlayer.damage * 1.3;
                    } else {
                        System.out.println("------------------------------------------------------------------------------------------");
